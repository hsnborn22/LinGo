...
func Translate(text string, languageId string, bootLanguage string) (string, string) {
	...
	apiurl := fmt.Sprintf("https://api.mymemory.translated.net/get?q=%s&langpair=%s|%s", encodedText, languageId, bootLanguage)
